  ...
  return (
    <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center">
        <div className="text my-5">
            <h1 className="text-5xl font-bold">Welcome to BookNest</h1>
            <p className="text-2xl my-7 px-1 dark:text-slate-300">Discover a world of knowledge with BookNest, Platform for an extensive collection of eBooks across every genre. We bring the world’s most popular and best-rated digital books right to your fingertips.</p>
